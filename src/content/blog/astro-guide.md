...
date: 2026-04-28
tags: ["Astro", "前端", "教程"]
description: "从零开始搭建 Astro 项目的完整流程"
---
...
Astro 组件使用类似 HTML 的语法，支持 `---` fence 中写 JavaScript/TypeScript：
...
4. **Tailwind CSS v4 + Astro 是绝配**：通过 Vite 插件集成，无需额外配置

> Astro 的哲学是：**Ship less JavaScript, build faster websites.** 如果你的网站主要是展示内容，Astro 是目前最好的选择。

掌握了这些基础，你就可以开始用 Astro 构建自己的博客或作品集了。接下来我会写一篇关于 Astro + Tailwind CSS v4 集成的详细教程，敬请期待。
